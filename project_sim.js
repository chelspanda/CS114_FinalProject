/* 
 * Chelsea Faustino & Linda Lam, CS 114, Final Project
 */
 ...
 * Global variables
 */
var meshResolution;     // stores integer n which determines the total number of particles

// Particle states
var mass;               // mass m for each particle
var vertexPosition, vertexNormal;
var vertexVelocity;

// Spring properties
//var K, restLength;      // K is vec3: K[0] = structural spring, K[1] = shear spring, K[2] = flexion spring
                        // restLength is vec3: restLengths of springs

// Force parameters
//var Cd;                 // coefficient for computing damping forces
//var uf, Cv;             // coefficients for computing viscous forces
